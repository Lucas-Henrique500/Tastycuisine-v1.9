...
const todasSugestoes = [
  ...
  'Panquecas de Aveia', 'Salmão Assado com Legumes', 'Lasanha de Abobrinha Vegana',
  'aveia', 'chia', 'banana', 'cacau', 'abacate', 'brócolis', 'quinoa',
  'sobremesas saudáveis', 'café da manhã', 'veganas', 'detox', 'low carb'
];
